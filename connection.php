...
<?php
    ...
    if(!$conn){
        ...
        //     )";
             $sql="INSERT INTO `users` (`id`, `username`, `password`, `email`, `stuname`, `gender`, `rel_id` ,`image`)
             VALUES(NULL,'$username','$password','$email','$stuname','$gender',$rel_id,'$fileLoc')";
...
$mail->Port = 587;
$mail->Username = 'cen.20bcec91@gmail.com';
$mail->Password = 'sourcecode12';
$mail->SMTPAuth = true;

$mail->From = 'cen.20bcec91@gmail.com';
$mail->FromName = 'salonyid';
